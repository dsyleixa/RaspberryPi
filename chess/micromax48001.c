...
// 48001:  main() implementiert,  D() mit Parameterliste,  W() zu while(), U verkleinert, keine Änderungen in Syntax etc.
...
#define U (1<<12)
struct _ {int K,V;int X,Y,D;} A[U];           /* hash table, 16M+8 entries*/

int M=136,S=128,I=8e3,Q,O,K,N,R,J,Z,k=16,*p;
int c[9]; /* M=0x88                */
