...
void put_VA(int startx, int starty) {
    ...
    */
    ...
    int GGx4= startx+63+60-39-80,  GGy4= starty+2 +120-30+60-30-2;        // GGG  to HA2-carry
    int GGx5= startx+63+60-20,     GGy5= starty+3 +120-30+60-30-2;        // GGG NOT to HA2-carry
    ...
    put_GliderReflxVertDnL( GGx4+27+50+4-10+15, GGy4+14+50-3-10+15);

    // GGG not to HA2-carry
    put_GliderGunRev( GGx5, GGy5 );
    EaterX[5] =  GGx5 + 5;
    EaterY[5] =  GGy5 + 14;
    //put_GliderEaterRev( EaterX[4], EaterY[4], 1); // test
...
MainWindow::onUpdateTime() {
      ...
      textposX[3] =(35+40)*blockSize ;       // Cin
      textposY[3] =(215)*blockSize-8;
