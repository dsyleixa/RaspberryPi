...
void put_Duplic(int startx, int starty) {
    ...
    int GGy1= starty + 1+30,   GGx1= startx + 39   -20 +1;      // A
    int GGy2= starty + 2+ 0,   GGx2= startx + 39*2  +4 -1;      // B
