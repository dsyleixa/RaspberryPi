...
//---------------------------------------------------------------------------
void put_XOR_R(int startx, int starty, char put_UI_Input=1) {
...
void put_HA(int startx, int starty, char put_UI_Input=1) {
    ...
    //put_XOR_L(startx+75-15-30 , starty+100+15+30, 0); // ok

    //test
    //put_XOR_R(startx+75-15-30  +42,    starty+100+15+30, 0);    // 1 A crash B hoch ok
    put_XOR_R(startx+75-15-30  +42,    starty+100+15+30 +2, 0); // 2 A okFW  B ok  !!!
