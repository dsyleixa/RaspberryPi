...
{
    ui->statusBar->showMessage("Test for GPIO pullup activated (still unfunctional)", 2000);
}


void MainWindow::on_actionGPIO24_pulldown_triggered()
{
    ui->statusBar->showMessage("Test for GPIO pulldown activated (still unfunctional)", 2000);
}
